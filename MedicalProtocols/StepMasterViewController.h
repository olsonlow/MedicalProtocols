...
@class MedProtocol;
@class ProtocolStep;
@class MedRefBaseDetailViewController;
...
@property (strong, nonatomic) MedRefBaseDetailViewController *detailViewController;;
@property (strong, nonatomic) ProtocolStep* selectedStep;
@end

...
///THIS FUNCTION IS NOT A FEATURE IT IS ONLY USED TO RELOAD TEST DATA.
-(void)reloadParse;
...
-(id)initWithDelegate:(id<MedRefDataSourceDelegate>)delegate
{
    ...
    //*****UNCOMMENT THIS LINE TO RELOAD THE PARSE DATABASE WITH TEST DATA, WHEN COMPLETE COMMENT THE LINE OUT************
    //*****CAUTION, BE SURE TO LOGIN TO SUPERUSER MODE IN THE APP AND DELETE ALL OBJECTS ALSO DELETE THE******************
    //*****APP FROM THE SIMULATOR BEFOR RELOADING.************************************************************************
...
///THIS FUNCTION IS NOT A FEATURE, JUST A FAST WAY TO LODA TEST DATA
-(void)reloadParse{
    ...
    linkObject[@"orderNumber"] = [NSNumber numberWithInt:5];
    ...
    textBlockObject2[@"orderNumber"] = [NSNumber numberWithInt:1];
    ...
    textBlockObject5[@"orderNumber"] = [NSNumber numberWithInt:1];
    ...
    calculatorComponent2[@"orderNumber"] = [NSNumber numberWithInt:4];
    ...
    textBlockObject6[@"orderNumber"] = [NSNumber numberWithInt:1];
    ...
    formComponent3[@"orderNumber"] = [NSNumber numberWithInt:1];
    ...
    selectionComponent6[@"label"] = @"Dull, Achy, not sharp, Diaphoresis, Nausia";
    ...
    textBlockObject7[@"orderNumber"] = [NSNumber numberWithInt:2];
